...
/* forwards */
static void checkdefs(void);
static void fmtbody(BODYTYPE *body, char *cent, char arrow);
static void posbody(BODYTYPE *body, int ystart);
static void usage(void);

static char *progname="rail";	/* program name */
...
BODYTYPE *
newbody(int kind, BODYTYPE *body1, BODYTYPE *body2)
{
	BODYTYPE *body;
...
static void
addlist(BODYTYPE *body1, BODYTYPE *body2)
{
...
BODYTYPE *
addbody(int kind, BODYTYPE *body1, BODYTYPE *body2)
{
	BODYTYPE *body;
	int i;
...
void
prtbody(int indent, BODYTYPE *body)
{
	int i;
...
void
outbody(IDTYPE *id, BODYTYPE *body)
{
	posbody(body,0);
...
static void
posbody(BODYTYPE *body, int ystart)
{
	BODYTYPE *body1;
	int i;
...
RULETYPE *
newrule(IDTYPE *id, BODYTYPE *body)
{
	RULETYPE *rule;
...
RULETYPE *
addrule(RULETYPE *rule1, RULETYPE *rule2)
{
	RULETYPE *rulep;
...
void
error(const char *f, const char *s)
{
	if(newline) {
		printf("\n");
		newline=0;
	...
	if(file!=NULL)
		fprintf(stderr,"%s, line %u: ",file,yylineno);
...
void
fatal(const char *f, const char *s)
{
	error(f,s);
