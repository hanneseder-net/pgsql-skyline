...
called \emph{query tree}.  Lookups into the system catalog are done in
...
For our implemenation it was not necessary to modify the \emph{query
...
to expensive.  
%
Various tradeoffs are made, more details see PostgreSQL documenation
...
This modification has an inpact on how the join trees are formed and
...
is implemented in \texttt{skyline\_choose\_method}\footnote{in
...
cite \citep{Buchta1989}, \citep{Chaudhuri2006}
...
\section{Cost-based operator selection}
see \autoref{sec:operatorselection, sec:cardinality-and-cost-estimation}.
\todo{}{}
