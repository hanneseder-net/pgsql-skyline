...
\comment{For the query sections all relevant information from the query plan is parsed into CSV format with the columns \texttt{runid}, \texttt{name} and \texttt{value}.\commentskip{}}
...
#--</query>
\end{interactive}
\caption{A log file parsed with \texttt{qp2log}}
...
\newdimen\paragraphccolumnwidth
\global\fixedcolumnwidth 2.2cm
\global\paragraphccolumnwidth\textwidth
\advance\paragraphccolumnwidth -\fixedcolumnwidth

\begin{table}[!ht]
\centering
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{\fixedcolumnwidth}@{\extracolsep{\fill}}p{\paragraphccolumnwidth}}
\verb|jobs/|      &  \\
...
\verb|[SKYLINENODE].method|		& \\
\verb|[SKYLINENODE].distinct|		& \\
\verb|[SKYLINENODE].dim|		& \\
\verb|[SKYLINENODE].attr|		& \\
\verb|[SKYLINENODE].passes|		& \\
\verb|[SKYLINENODE].passes.rows|	& \\
\verb|[SKYLINENODE].windowsize|		& \\
\verb|[SKYLINENODE].windowslots|	& \\
\verb|[SKYLINENODE].windowpolicy|	& \\
\verb|[SKYLINENODE].cmps.tuples|	& \\
\verb|[SKYLINENODE].cmps.fields|	& \\
\verb|[SKYLINENODE].cmps.ratio|		& \\

\smallskip

\verb|seqscan{.ALIAS}.on|		& \\
\verb|seqscan{.ALIAS}.tablesize|	& HACK: derived from the tablename \\
...
the columns (cf. Figure~\ref{fig:pivot_log}).
