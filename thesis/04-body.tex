...
\citep{Godfrey2007}.
%
Therefore building a skyline query optimizer is a  challenging task.
...
\bigskip
\noindent
So far we have implemented the non-index-based algorithms
...
We propose a new use case for the elimination filter and
...
implementations.
%
The experimental environment we have designed and se up is noteworthy
on its own.
%
