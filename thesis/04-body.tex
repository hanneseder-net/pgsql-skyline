...
\todo{in the condition replace r with o resp. i}{}
...
\noindent
The principle use here is different, the skyline of a set is the set
without those tuples that have a \emph{wittness}\index{wittness}. This
...
\begin{verbatim}
explain select * from a15d1e3s0
except
select i.* from a15d1e3s0 o, a15d1e3s0 i 
