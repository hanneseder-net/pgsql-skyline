...
in the following sections.  But first of all we describe which types of
...
all it takes is to run PostgreSQL's \texttt{initdb} and to install the set
returning function. We did so many times when merging the PostgreSQL
...
distinct and non-distinct one dimensional skylines could be speedup by
