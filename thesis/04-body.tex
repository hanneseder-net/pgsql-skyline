...
precise we must speak of \emph{pathkeys}, i.e. both of the above skyline
queries can make use of the following index, but only the first query
with a \inlinesql{ORDER~BY}-clause:
...
\emph{pathkeys} as described in Section~\ref{sec:pathkeys}. As a
