...
%pagination: move both versions of BNL to their own page
%\begin{figure}[htbp]
...
[\textnormal{min}, \textnormal{max}]$ as sum of \emph{dim}
...
PostgreSQL installation follow the instructions in
...
and shows the actual runtime. See PostgreSQL documentation on
...
This ``seven'' is just because of we did not have more.
%
