...
\]}
%
both element of a $n$-ary relation $\relation R$, then the \emph{skyline preference formula} is of the form:
%
% \[
% r \dominates s
%\]
...
We now like to define the \emph{skyline operator} with is a special
...
then the \emph{skyline operator} denoted by
...
\subsubsection{\inlinesql{DIFF}-Induced Equalitity Relation}
