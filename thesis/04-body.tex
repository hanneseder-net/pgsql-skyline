...
%
In addition, we extended the standard syntax to specify the following
aspects:
\idxonlysql{USING}
\begin{itemize}
...
experiments are online accessible at this website. Furthermore it is
possible to test-drive our implementation through a web-interface.
