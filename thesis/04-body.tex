...
\noindent
In terms of a dominance relation this can be expressed as:

\begin{equation}
\dominates = \{(c_i, a_i) | i \in \{1, \ldots, n\}\},
\end{equation}
...
a little better in each dimension than the $a_i$'s.

\noindent
It is easy to see that following identities hold:
...
\todo{explain non termination}{}

Note that a relation or a set does not have the concept of
\emph{nextness}, but we treat it here like a physical table, where
