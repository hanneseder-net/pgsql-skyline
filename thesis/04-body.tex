...
this effort the skyline operator is in the habbitat it belongs to.

A note worthy result of our efforts the web-site
...
flavor of SQL extension with a preference clause will make it into an
SQL standard in near future.
