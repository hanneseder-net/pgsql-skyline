...
In the real code we do concern issues of software engineering, like error handling, which we 
ignore in the pseudocode to convey the essence of the algorithms more concisely.

Pseudocode conventions: see \citep[Page 19]{Cormen2001}

no begin/end only indent like in python

we do explicitly break at the end of case statements as in some situations
