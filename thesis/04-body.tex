...
\autoref{sec:rewrite-to-sql} we show how to rewrite a SQL query with
...
\begin{itemize}
\item 
From a users perspective, it is easier to specify and easier to grasp
...
\item
It is faster to evaluate, as there a numerous algorithms for skyline
queries. Furthermore when this preference query is with a correlated
subselect it boiles down to a \naive ``nested-loop'' and
\citet{Grust1997, Braumandl1998} show that such query cannot be
unnested.
...
\section{Focus of this Thesis and Main Results}
...
operator and the evaluating of skyline algorithms in the RDBMS context.
...
syntax for preference queries is desireable.
...
e.g. when and how to push a skyline operator through a join, who to
simlify multiple preference operators, and so forth, together with
