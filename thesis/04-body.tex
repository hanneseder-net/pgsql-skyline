...
%fang: I cannot understand this sentence
...
query plan specify the option \inlinesql{EF}.  
%fang: it is not a sentence
If the
...
default in the query optimizer, %fang: what is work horse, ???
...
\inlinesql{NULLS FIRST/LAST} overrides this default.  Questions
