...
\]}
%
both elements of a $n$-ary relation $\relation R$, then the \emph{skyline preference formula} is of the form:
%
% \[
% r \dominates s
%\]
...
\begin{definition}[Comparable]The tuples are $r$ and $s$ are \emph{comparable} iff $r$ dominates $s$ or $s$ dominates $r$:
\[
...
0$.  Therefore there is not linear scoring function which gives
$(2,2)$ the best score.
