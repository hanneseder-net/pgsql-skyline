...
\railalias{select_limit}{select\_limit}
...
\begin{figure}[htbp]
\centering
\subfloat[Density Plot]{\includegraphics[width=100mm]{plots-density/density-2d-i2d1e5}}
\subfloat[Statistics]{
\begin{tabular}{r|rr}
	& d1 	& d2 \\
\hline
...
\begin{figure}[htbp]
\centering
\subfloat[Density plot]{\includegraphics[width=100mm]{plots-density/density-2d-c2d1e5}}
\subfloat[Statistics]{
\begin{tabular}{r|rr}
	& d1 	& d2 \\
\hline
...
\begin{figure}[htbp]
\centering
\subfloat[Density Plot]{\includegraphics[width=100mm]{plots-density/density-2d-a2d1e5}}
\subfloat[Statistics]{
\begin{tabular}{r|rr}
	& d1 	& d2 \\
\hline
...
\begin{figure}[ht]
\centering
\subfloat[Independent dataset]{\includegraphics[width=72.5mm]{plots-profile/presort-i}} \\
\subfloat[Correlated dataset]{\includegraphics[width=72.5mm]{plots-profile/presort-c}} \\
\subfloat[Anti-correlated dataset]{\includegraphics[width=72.5mm]{plots-profile/presort-a}}
\caption{Absolute timing for different physical skyline operators in the 2 dimensional case}
\end{figure}
\begin{figure}[ht]
\centering
\subfloat[Independent dataset (100k tuples)]{\includegraphics[width=72.5mm]{plots-profile/sfs-index-i-100000}} \\
\subfloat[Correlated dataset (100k tuples)]{\includegraphics[width=72.5mm]{plots-profile/sfs-index-c-100000}} \\
\subfloat[Anti-correlated dataset (100k tuples)]{\includegraphics[width=72.5mm]{plots-profile/sfs-index-a-100000}}
\caption{Relative timing for SFS/SFS+EF when usning index access paths (100k tuples)}
\end{figure}
\onecolumn
