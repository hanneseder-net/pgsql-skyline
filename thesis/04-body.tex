...
have a \emph{wittness}.

\bigskip
\noindent
We now like to introduce some futher concepts:
...
appeares in \citep{Chan2005}, but probably was also in early works.
%
...
\le k \le l \le m \le n$ and $1 < m \le n$) and following schema:
%
\begin{sql}
...
have some non-deterministic feature, so we somehow have to express if
...
\noindent
The later is easy, as we just have to eliminate duplicates, which can be
