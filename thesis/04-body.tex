...
each node consumes the tuples from its children and produces tuples
...
\todo{It is coded in the fashion of a state machine.  Do something in each state and then proceed to another state.  The state is stored in the node's execution state information and is preserved across calls.}{}
