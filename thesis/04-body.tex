...
which only works in the two dimensional case, it was pointed out by 
...
in the description of query execution (cf. \autoref{sec:queryexecution}).
...
architecture, i.e. each node consumes the tuples from its childrens and
