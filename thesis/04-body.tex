...
\idxsql{DIFF} and \inlinesql{DISTINCT} keyword. \idxonlysql{SKYLINE OF DISTINCT}
...
\idx{RDBMS} PostgreSQL with the skyline operator.  It is our strong belief that with
...
skyline query is not more than $0.1$; (2) for datasets up to $500$ tuples
