...
gave our self the freedom to present the tuple store\index{tuple store} interface
...
compare every tuple to all others as long no witness\index{witness} is found, which
